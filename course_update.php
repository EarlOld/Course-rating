  ...
  <script type="text/javascript">
    $(document).ready(function() {
      $.ajax({
        url: 'main-findCourse.php',
          ...
          success: function(data){
            ...
            console.log(data);
            for(id in data){
              $("select[name=departament]").append($("<option value='"+data[id].Cour_key+"'>"+data[id].Cour_name+"</option>"));
              }
          }
      });
      ...
      $('input#enter').click(function() {
        ...
        var newdepartament = {newdepartament: $("input[name=input_departament]").val()};
        console.log(newdepartament);
        $.ajax({
          url: 'main-updateCourse.php',
          type: 'GET',
      ...
      $("select[name=departament]").bind("change", function(){
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            for(id in data){
              $("input[name=input_departament]").val(data[id].Cour_name);
            }
...
<div class="form" align="center">
  <form name="input" method="post">
    ...
    <table id="info-group">
      ...
      <tr>
        <td colspan="2" align="center"><input id="enter" class="button8" type="button" value="Оновити дані" name="enter" align="center"></td>
      </tr>
    </table>
  </form>
</div>
